  ...
  return (
    <main className="min-h-screen bg-ink bg-hero-gradient text-white">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-20 px-5 py-10 sm:px-8 sm:py-16 lg:gap-24 lg:px-12">
        <header className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 backdrop-blur sm:px-5">
          <div>
            <p className="text-sm font-semibold tracking-tight text-white sm:text-base">EuroChat AI</p>
            <p className="text-[11px] text-slate-300 sm:text-xs">Asistente financiero por WhatsApp</p>
          </div>
          <button className="rounded-xl border border-white/20 px-4 py-2 text-xs font-medium text-white transition hover:bg-white/10 sm:text-sm">
            Solicitar acceso
          </button>
        </header>
